...
\[
    \infrule[Read]{
       ...
       < (X\;\leftarrow\; [ a ]),\;Some(s,\;h) > \; \Downarrow Some\;([s\;|\;X:n],\;h)
    }
\]
\\
\[
    \infrule[Write]{
       ...
       < ([ a ]\;\leftarrow\; b),\;Some(s,\;h) > \; \Downarrow Some\;([s\;|\;X:a],\;write\;a\;b\;h)
    }
\]
\\
\[
...
\[
    \infrule[ReadError]{
       ...
       < (X\;\leftarrow\; [ a ]),\;Some(s,\;h) > \; \Downarrow None
    }
\]
\\
\[
    \infrule[WriteError]{
       ...
       < ([ a ]\;\leftarrow\; b),\;Some(s,\;h) > \; \Downarrow None
    }
\]
\\
\[
